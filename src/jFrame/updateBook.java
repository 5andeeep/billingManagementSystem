...
public class updateBook extends javax.swing.JFrame {
    ...
    public void updateBuyerDetailsFunction(){
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            st.executeUpdate("update book set Name='"+Name+"', Price='"+Price+"',Author='"+Author+"', Genre='"+Genre+"', Quantity='"+Quantity+"' where bookId='"+bookId+"'");
...
//        String contactNo1 = jTextField1.getText();
        ...
        if(Genre.equals("")){
            JOptionPane.showMessageDialog(null, "Please enter book genre.");
            return false;
        }
        if(Quantity.equals("")){
